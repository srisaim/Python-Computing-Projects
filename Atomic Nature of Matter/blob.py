...
class Blob:
    ...
    # X & Y coordinates are floats while number of pixels is int.
    def __init__(self):
    ...
    # Use the idea of running average to update the center of mass of blob.
    # Increment number of pixels by 1.
    def add(self, x, y):
    ...
    # Return number of pixels in blob.
    def mass(self):
        return self._pixels
